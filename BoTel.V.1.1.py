...
"""
 Mokol = message.from_user.username
...
# col1 img
acccol1img = InlineKeyboardButton(text="تایید" , callback_data="acc1")
rejcol1img = InlineKeyboardButton(text="لغو" , callback_data="rej1")
finalmarkcol1img = InlineKeyboardMarkup(row_width=2)
finalmarkcol1img.add(acccol1img , rejcol1img)

# col3 img
acccol3img = InlineKeyboardButton(text="تایید" , callback_data="acc2")
rejcol3img = InlineKeyboardButton(text="لغو" , callback_data="rej2")
finalmarkcol3img = InlineKeyboardMarkup(row_width=2)
finalmarkcol3img.add(acccol3img , rejcol3img)

# col3 no img
acccol3noimg = InlineKeyboardButton(text="تایید" , callback_data="acc3")
rejcol3noimg = InlineKeyboardButton(text="لغو" , callback_data="rej3")
finalmarkcol3noimg = InlineKeyboardMarkup(row_width=2)
finalmarkcol3noimg.add(acccol3noimg , rejcol3noimg)


# col4 no img
acccol4noimg = InlineKeyboardButton(text="تایید" , callback_data="acc4")
rejcol4noimg = InlineKeyboardButton(text="لغو" , callback_data="rej4")
finalmarkcol4noimg = InlineKeyboardMarkup(row_width=2)
finalmarkcol4noimg.add(acccol4noimg , rejcol4noimg)


# col4 img
acccol5img = InlineKeyboardButton(text="تایید" , callback_data="acc5")
rejcol5img = InlineKeyboardButton(text="لغو" , callback_data="rej5")
finalmarkcol5img = InlineKeyboardMarkup(row_width=2)
finalmarkcol5img.add(acccol5img , rejcol5img)

# col4 no img2
acccol4noimg2 = InlineKeyboardButton(text="تایید" , callback_data="acc6")
rejcol4noimg2 = InlineKeyboardButton(text="لغو" , callback_data="rej6")
finalmarkcol4noimg2 = InlineKeyboardMarkup(row_width=2)
finalmarkcol4noimg2.add(acccol4noimg2 , rejcol4noimg2)

# col4 img2
acccol4img2 = InlineKeyboardButton(text="تایید" , callback_data="acc7")
rejcol4img2 = InlineKeyboardButton(text="لغو" , callback_data="rej7")
finalmarkcol4img2 = InlineKeyboardMarkup(row_width=2)
finalmarkcol4img2.add(acccol4img2 , rejcol4img2)
...
def defs(message):
    if message.text == "ثبت آگهی 📮" :
        ...
        rules(message)
    elif message.text == "پشتیبانی ⚠️":
        support(message)
    elif message.text == "کانال ها 📣":
        channells(message)
        ...
        bot.send_message(message.chat.id , text="متوجه نشدم !")
    return False
# orgcall
...
def callback(call):
     if call.data == "acc2":
         ...
         conadmincol4noimg(call)
     elif call.data == "acc5":
         conadmincol4img(call)
     elif call.data == "acc6":
         conadmincol4noimg2(call)
     elif call.data == "acc7":
         conadmincol4img2(call)
...
"لطفا ایدی خود را بدون @ وارد کنید :


مانند :
rednews2022
        """)
    bot.register_next_step_handler(msg, agahirig)
...
def concol1img(message):
    if message.text == "تایید آگهی":
        bot.send_photo(chat_id=6380845241, caption=captioncol1, photo=imgcol1 , reply_markup=finalmarkcol1img)
...
def callback_query(call):
    destination_chat_id = -1002082838611
...
📣 @rednews2022 @havashi_russ_2022 @niazmndiha_2024_rus
    ...
    if message.text == "تایید آگهی":
        bot.send_message(chat_id=6380845241, text=text , reply_markup=finalmark)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
def conimgcol3(message):
    if message.text == "تایید آگهی":
        bot.send_photo(chat_id=6380845241, caption=captioncol3, photo=photocol3, reply_markup=finalmarkcol3img)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
📣 @rednews2022 @havashi_russ_2022 @niazmndiha_2024_rus
    """
    if message.text == "تایید آگهی":
        bot.send_message(chat_id=6380845241, text=text , reply_markup=finalmarkcol3noimg)
...
📣 @rednews2022 @havashi_russ_2022 @niazmndiha_2024_rus
    """
        bot.send_message(destination_chat_id, text=text)
...
def conimgcol4(message):
    if message.text == "تایید آگهی":
        bot.send_photo(chat_id=6380845241, caption=captioncol4, photo=photocol4 , reply_markup=finalmarkcol4img2)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",
                         reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
📣 @rednews2022 @havashi_russ_2022 @niazmndiha_2024_rus
    """
    if message.text == "تایید آگهی":
        bot.send_message(chat_id=6380845241, text=text ,reply_markup= finalmarkcol4noimg)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",
                         reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
📣 @rednews2022 @havashi_russ_2022 @niazmndiha_2024_rus
    """
    if message.text == "تایید آگهی":
        bot.send_message(chat_id=6380845241, text=text , reply_markup=finalmarkcol4noimg2)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
def other6(message):
    ...
    📣 @rednews2022 @havashi_russ_2022 @niazmndiha_2024_rus        
                   """
    if message.text == "تایید آگهی":
        bot.send_message(chat_id=6380845241, text=text)
        bot.send_message(message.chat.id, text="آگهی شما ثبت شد و پس از تایید در کانال قرار داده میشود✅",
                         reply_markup=markup2)
    elif message.text == "لغو آگهی":
        bot.send_message(message.chat.id, text="آگهی شما لغو شد❌", reply_markup=markup2)
...
def confirm(message):
    ...
    if tct == "لغو ❌":
        ...
        bot.send_message(chat_id=6380845241, text=f"""
    ارسالی از تیکت
نام ارسال کننده :
{UFN}
آیدی ارسال کننده :
...
def start2(message):
    ...
    ❌yhh\این ربات توسط گروه راشسان (Rush sun) توسعه یافته است!❌
